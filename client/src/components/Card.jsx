    ...
    <div className='sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer ' onClick={handleClick}>
      ...
      <div className='flex flex-col p-4'>
        <div className='flex flex-row items-center mb-[18px] '>
          ...
          <p className='ml-[12px] mt-[2px] font-epilogue font-medium text-[12px] text-[#808191] ' >FundRaising</p>
        </div>
        ...
        <div className='flex justify-between flex-wrap mt-[15px] gap-2'>
          <div className='flex flex-col' >
            ...
            <p className='mt-[3px] font-epilogue font-normal text-[12px] text-[#808191] sm:max-w-[120px] truncate leading-[18px]'>Raised out of {target}</p>
          </div>
          <div className='flex flex-col' >
            <h4 className='font-epilogue font-semibold text-[14px] text-[#b2b3bd] leading-[22px] ' >{remainingDays}</h4>
            <p className='mt-[3px] font-epilogue font-normal text-[12px] text-[#808191] sm:max-w-[120px] truncate leading-[18px]'>Days Left</p>
          </div>
        </div>
